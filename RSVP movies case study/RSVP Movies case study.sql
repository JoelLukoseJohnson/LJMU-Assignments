...
-- Id_nulls = 0, titile_nulls = 0, date_published_nulls = 0, duration_nulls = 0
-- country_nulls = 20, worlwide_gross_income_nulls = 3724, languages_nulls = 194, production_company_nulls = 528
...
-- In 2017 = 3052 movies, 2018 = 2944 movies, 2019 = 2001 movies
...
-- March month = 824 movies which is highest
...
-- 3289 movies with only one genre
...
-- Action genre has the highest duration of 112.88 seconds, followed by romance - 109.53 seconds, and crime - 107.05 seconds
...
-- 2257 movies we have with median_rating 7.
...
-- We have 8 movies which begin with "The" in their title.
...
-- German movies received the highest number of votes than Italian
...
-- Three Top production houses are Marvel Studios, Twentieth Century Fox and Warner Bros.
...
-- Top Three actresses based on number of Super Hit movies are Parvathy Thiruvothu, Susan Brown and Amanda Lawrence
